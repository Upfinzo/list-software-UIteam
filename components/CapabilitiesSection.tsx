...
export const defaultCapabilityTabs: CapabilityTab[] = [
  {
    ...
    title: "Core Banking",
    description:
      "Power essential banking operations with reliable core banking technology.",
    icon: <Landmark />,
    badges: ["Accounts", "Deposits", "Loans", "Customers", "Branch operations"],
    items: ["Accounts", "Deposits", "Loans", "Customers", "Branch operations"],
  },
  {
    id: "move-money",
    label: "Move Money",
    title: "Move Money",
    description: "Connect banking operations with India's payment ecosystem.",
    icon: <CreditCard />,
    badges: ["EFT / RTGS", "NACH", "CTS", "Positive Pay", "Settlement"],
    items: ["EFT / RTGS", "NACH", "CTS", "Positive Pay", "Settlement"],
  },
  {
    id: "engage-grow",
    label: "Engage & Grow",
    title: "Engage & Grow",
    description:
      "Extend banking experiences across mobile, web and assisted channels.",
    icon: <Smartphone />,
    badges: [
      "Mobile banking",
      "Internet banking",
  ...
  {
    id: "control-optimise",
    label: "Control & Optimise",
    title: "Control & Optimise",
    description:
      "Gain visibility and control with analytics, risk and compliance tooling.",
    ...
    >
      <Container>
        ...
        <div className="mb-8 md:mb-12 max-w-3xl">
          <span className="text-xs font-bold uppercase tracking-[0.2em] text-[#111E89] mb-3 block">
            CAPABILITIES
          </span>
          <h2 className="sm:text-[42px] lg:text-[45.6px] font-semibold tracking-tight text-[#121F37] leading-[1.15]">
          ...
          >
            ...
            >
              ...
              <div className="lg:col-span-6 space-y-6">
                ...
                {/* Title */}
                <h3 className="text-2xl sm:text-3xl font-bold text-[#121F37] tracking-tight">
                  {activeTab.title}
                </h3>
